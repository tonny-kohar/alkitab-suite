 ...
 * @author tonny
 */
public final class PassageAction extends AbstractAction {

    public PassageAction() {
        super(NbBundle.getMessage(PassageAction.class, "CTL_PassageAction"));
    }
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (tc instanceof ParallelBookTopComponent) {
            ((ParallelBookTopComponent)tc).requestFocusForPassageComponent();
        }
    }
}
